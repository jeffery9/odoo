...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template name="stylesheet">
		<paraStyle name="title" fontName="SimSun" fontSize="15.0" alignment="center"/>
		<paraStyle name="terp_tblheader_General" fontName="SimSun" fontSize="8.0" leading="10" alignment="LEFT"/>
		<paraStyle name="terp_default_8" fontName="SimSun" fontSize="8.0" leading="10" alignment="LEFT" spaceBefore="0.0" spaceAfter="0.0"/>
		<paraStyle name="terp_tblheader_Details_Right" fontName="SimSun" fontSize="8.0" leading="10" alignment="RIGHT"/>
		<paraStyle name="terp_tblheader_Details_Right_bold" fontName="SimSun" fontSize="8.0" leading="10" alignment="RIGHT"/>
